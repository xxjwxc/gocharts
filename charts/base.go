...
type BaseConfiguration struct {
	...
	opts.Polar      `json:"polar,omitempty"`
	opts.AngleAxis  `json:"angleAxis"`
	opts.RadiusAxis `json:"radiusAxis"`
	opts.Grid       `json:"grid,omitempty"`
	opts.XAxis      `json:"xAxis"`
	opts.YAxis      `json:"xAxis"`
...
func (bc *BaseConfiguration) Unmarshal() string {
	obj := bc.json()
	return tools.JSONDecode(obj)
}
